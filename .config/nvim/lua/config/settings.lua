...
set.foldmethod = "marker" -- enable folding (default 'marker', "expr")
...
-- Editor UI
-------------------------------------------------------------------------
set.pumblend = 0 -- Enable transparency for popup menu
set.pumheight = 20  -- height of popup menu
set.pumwidth = 30   -- width of popup menu
set.cmdheight = 1 -- more space for displaying msg
...
vim.opt.listchars:append("eol:󱞤")
...
-- 4 spaes for selected filetypes
cmd([[
  autocmd FileType python,java,c,cpp setlocal shiftwidth=4 tabstop=4
]])
